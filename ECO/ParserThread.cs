...
namespace ECO
{
    ...
    class ParserThread
    {
        ...
        public const int numberOfDownloadingThreads = 6; //Each thread takes roughly 800mb ram usage. This can and will probably be optimized in the future. 5 for each parsing thread is usually enough.
